...
public class TrainerProfile extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.trainerprofile);
		setActionBar("Trainer Profile");
		...
		Spinner speciality = (Spinner)findViewById(R.id.goal_spinner);
	...
	public void onClick(View v) {
		...
		String primary_specialty = speciality.getSelectedItem().toString();
		String trainer;
