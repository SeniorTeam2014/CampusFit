...
public class RetrieveTrainer extends AsyncTask<String,Void,String> {
	InputStream is = null;
	String result = "";
		@Override
	protected String doInBackground(String... params) {
		...
		try{
			...
			GlobalVariables.trainers = new ArrayList<String>();
			...
			else
			{
				for(int i = 0; i < u.length(); i++)
				{
					...
					GlobalVariables.trainers.add(input);
				}
				for(int i = 0; i < GlobalVariables.trainers.size(); i++)
					System.out.println("M: " + GlobalVariables.trainers.get(i));
			}
